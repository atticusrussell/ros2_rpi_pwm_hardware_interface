...
#ifndef RPI_PWM_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define RPI_PWM_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // RPI_PWM_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
